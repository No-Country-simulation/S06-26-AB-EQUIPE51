...
export default function CadastroVaga() {
  ...
  async function onSubmit(dadosFormulario) {
    ...
    const payload = {
      ...
      skills,
      diversidade: diversidadeSelecionada, // ← novo campo no payload
      // ⚠️ confirmar com o backend o formato esperado deste campo
    };
    ...
    try {
      ...
      reset();
      setSkills([]);
      setDiversidadeSelecionada({}); // ← reseta após enviar
    } catch (error) {
              ...
              <div className={styles.grupo}>
                ...
                <div
                  className={`${styles.inputGroup} ${
                    errors.titulo ? styles["inputGroup--erro"] : ""
                  }`}
                >
                  <input
                ...
                {errors.titulo && (
                  <span className={styles.erro}>{errors.titulo.message}</span>
                )}
              </div>
